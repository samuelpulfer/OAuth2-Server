...
public class JWTHelper {
	 ...
	 * @param jti The code of the token.
	 * @return An example JWT payload.
	 */
	...
	/** Generates a RSA signed JWT token.
	 * @param payload The payload to use.
	 * @return The RSA signed JWT token.
	...
	/** Generates a HMAC signed token.
	 * @param payload The payload to use.
	 * @param secret The secret to sign the token
	 * @return The HMAC signed token.
	 * @throws NoSuchAlgorithmException
	 * @throws InvalidKeyException
	 */
